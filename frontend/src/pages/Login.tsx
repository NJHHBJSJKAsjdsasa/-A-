      ...
      <div className="card max-w-md w-full">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-gray-500">{t('login.orLoginWith')}</span></div>
          </div>
          <div className="grid grid-cols-3 gap-3 mt-4">
            <button className="border-2 border-gray-200 rounded-xl py-2 hover:border-doraemon-blue transition-colors">{t('login.wechat')}</button>
            <button className="border-2 border-gray-200 rounded-xl py-2 hover:border-doraemon-blue transition-colors">QQ</button>
            <button className="border-2 border-gray-200 rounded-xl py-2 hover:border-doraemon-blue transition-colors">{t('login.weibo')}</button>
          </div>
        </div>
